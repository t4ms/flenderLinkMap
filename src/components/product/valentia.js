...
const summary = [
  ...
  {
    id: 4,
    contentDe: "Hohe Wirkstoffpotenz d.h. geringe Wirkstoffausbringung und Gewässerbelastung",
    contentEn: "Hohe Wirkstoffpotenz d.h. geringe Wirkstoffausbringung und Gewässerbelastung",
    target: "",
    href: "",
    highlightDe: "",
    highlightEn: "",
      ...
      <div className="relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
        <div className="lg:col-start-2 lg:pl-8">
          <div className="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
            <h2 className="leading-6 text-green-medium font-semibold tracking-wide uppercase">Valentia</h2>
                    ...
                    <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                      <div>
                        <p className="text-sm text-black">
                          {props.lang==='de' ? event.contentDe : event.contentEn} 
                          <a
                            href={event.href}
                      ...
                      <div className="text-right font-bold text-sm whitespace-nowrap text-green-lighter">
                        <p>{props.lang==='de' ? event.highlightDe : event.highlightEn} </p>
                      </div>
                    </div>
                  </div>
                </div>
