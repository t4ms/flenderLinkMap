...
const people = [
  {
    name: 'Hugo Schweers',
    role: 'Modern strategy development',
    imageUrl: 
    'https://media-exp1.licdn.com/dms/image/C4D03AQHDeWUAJ5Efmw/profile-displayphoto-shrink_800_800/0/1599731929331?e=1636588800&v=beta&t=Sb1EUM7OoyOdJR97qOl8DE7HgQ-GTYrGVv-Hiyi8Ax8',
    twitterUrl: '#',
    linkedinUrl: '#',
  },
  {
    ...
    role: 'Modern strategy development',
    imageUrl: 
    'https://profile-images.xing.com/images/3c8d519d5b8b468df84406a5d5a05459-1/bernd-bund.1024x1024.jpg',
    twitterUrl: '#',
    linkedinUrl: '#',
  },
...
export default function team() {
  return (
    <div className="bg-fgDefault-dark">
    <Navbar />
